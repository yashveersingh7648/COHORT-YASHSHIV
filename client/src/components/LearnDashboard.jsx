...
//               <div className="card-grid">
//                 <div className="card">
//                   <h3><FaUniversity /> Civil Courts (District & High Courts)</h3>
//                   <ul>
//                     <li><strong>Jurisdiction:</strong> Used for filing summary suits under Order XXXVII of the Civil Procedure Code (CPC) for undisputed debts.</li>
//                     <li><strong>Use Case:</strong> Ideal for private lenders, service providers, or when no specialized tribunal applies.</li>
//                     <li><strong>Limitation:</strong>Slower process, higher cost, and procedural complexity.</li>
//                   </ul>
//                 </div>
...
//                   <ul>
//                     <li><strong>Established Under:</strong> Recovery of Debts Due to Banks and Financial Institutions Act (RDDBFI), 1993.</li>
//                     <li><strong>Jurisdiction:</strong> Handles cases where debt exceeds ₹20 lakh and involves banks or NBFCs.</li>
//                     <li><strong>Process:</strong> Faster than civil courts; allows direct filing by financial institutions.</li>
//                     <li><strong>Appeals:</strong> Heard by Debt Recovery Appellate Tribunals (DRATs)—there are 5 DRATs and over 30 DRTs across India.</li>
//                   </ul>
//                 </div>
...
//                     <li><strong>Power:</strong> Allows secured creditors to seize and sell collateral without court intervention.</li>
//                     <li><strong>Support:</strong> District Magistrates assist in enforcement if borrower resists possession.</li>
//                     <li><strong>Use Case:</strong> For secured loans (e.g., property-backed), especially by banks and NBFCs.</li>
//                   </ul>
//                 </div>
  
//                 <div className="card">
//                   <h3><FaBalanceScale /> Insolvency & Bankruptcy Code (IBC), 2016</h3>
//                   <ul>
//                     <li><strong>Forum:</strong> National Company Law Tribunal (NCLT) for corporate debtors; Debt Recovery Tribunal for individuals.</li>
//                     <li><strong>Trigger:</strong> When borrower defaults and resolution is sought via insolvency.</li>
//                     <li><strong>Outcome:</strong> Can lead to restructuring, liquidation, or settlement.</li>
//                   </ul>
//                 </div>
...
//                   <ul>
//                     <li><strong>Applicable Laws:</strong> Indian Penal Code (IPC) – for fraud, cheating, or criminal breach of trust.</li>
//                     <li><strong>Use Case:</strong> When recovery involves criminal misconduct or dishonored instruments.</li>
//                   </ul>
//                 </div>
...
//                     <li><strong>Use Case:</strong> Fast-track resolution for contractual disputes or private lending.</li>
//                     <li><strong>Enforcement:</strong> Arbitration awards can be enforced via civil courts.</li>
//                   </ul>
//                 </div>
                
//               </div>
//                 <div className="card warning-card">
//                 <h4>Strategic Implications for Suppcohort</h4>
//                 <ul>
//                   <li><b>Partner Onboarding: </b>Ensure recovery partners understand which forum applies based on loan type, amount, and borrower profile.</li>
//                   <li><b>Training Modules: </b>Include judiciary pathways in agent certification—especially DRT vs SARFAESI vs IBC.</li>
//                   <li><b>Data Mapping: </b>Align borrower segmentation with legal recovery options (e.g., unsecured vs secured, individual vs corporate).</li>
//                   <li><b>Compliance SOPs: </b>Build workflows that respect jurisdiction, timelines, and borrower rights.</li>
//                 </ul>
//               </div>
//             </section>
//           )}
...
//                   <p><b>Initial Reminder: </b>Phone calls, SMS, and emails reminding the borrower of missed EMIs.</p>
//                   <p><b>Demand Notice: </b>Formal written notice requesting payment within a specified time (usually 15–30 days).</p>
//                   <p><b>Contents: </b>Loan details, overdue amount, consequences of non-payment.</p>
...
//                  <p><b>Trigger:  </b>If the borrower fails to respond or repay after notices.</p>
//                   <p><b>Legal Basis:  </b>As per the loan agreement and RBI’s Fair Practices Code.</p>
//                   <p><b>Process: </b>A repossession memo is issued and signed by both parties.</p>
//                 </div>
  
//                 <div className="process-step">
//                   <div className="step-icon"><FaNewspaper /></div>
//                   <h3>3. Pre-Sale Notice</h3>
//                   <p><b>Purpose:   </b>Inform borrower of intent to sell the repossessed vehicle.</p>
//                   <p><b>Timeline:   </b>Typically 7–15 days to allow borrower to repay and reclaim the vehicle.</p>
//                   <p><b>Includes:  </b>Vehicle valuation, auction details, and outstanding dues.</p>
//                   </div>
  
//                 <div className="process-step">
//                   <div className="step-icon"><FaMoneyCheckAlt /></div>
//                   <h3>4. Auction or Sale of Vehicle</h3>
//                    <p><b>Method:    </b>Public auction or private sale.</p>
//                   <p><b>Requirement:   </b>Transparent process with proper documentation.</p>
//                   <p><b>Proceeds:   </b>Adjusted against outstanding loan. Any surplus is returned to borrower; shortfall may lead to further legal action.</p>
//                   </div>
  
//                 <div className="process-step">
//                   <div className="step-icon"><FaFileAlt /></div>
//                   <h3>5. Legal Notice Before Filing Suit</h3>
//                    <p><b>Issued If:     </b>Vehicle sale doesn’t cover full dues or borrower contests repossession.</p>
//                   <p><b>Contents:    </b>Final warning before initiating civil suit for recovery of balance amount.</p>
//                     </div>
  
//                 <div className="process-step">
//                   <div className="step-icon"><FaGavel /></div>
//                   <h3>6. Civil Suit for Recovery</h3>
//                      <p><b>Filed Under:     </b>Indian Contract Act or CPC (Civil Procedure Code).</p>
//                   <p><b>Court:    </b>Jurisdiction depends on loan amount and borrower’s location.</p>
//                   <p><b>Relief Sought:    </b>Recovery of outstanding dues, interest, and legal costs.</p>
//                   </div>
  
//                 <div className="process-step">
//                   <div className="step-icon"><FaExclamationTriangle /></div>
//                   <h3>7. Criminal Action (If Applicable)</h3>
//                   <p><b>Cheque Bounce:      </b>Under Section 138 of Negotiable Instruments Act.</p>
//                   <p><b>Fraud or Misrepresentation:     </b>FIR may be filed if borrower provided false documents or absconded with the vehicle.</p>
//                     </div>
//               </div>
...
//                   <h3><FaClipboardList /> Repossession Memo (Post-Vehicle Seizure)</h3>
...
//                 <div className="template-card">
//                   <h3><FaNewspaper /> Pre-Sale Notice (Before Auction/Sale)</h3>
//                   <div className="template-content">
...
//               <h2> NCLT vs NCLAT: Structure & Strategic Role</h2>
...
//   <div className="card">
//                <h3><FaUserTie /> Recovery Agent Engagement</h3>
//       <ul>
//         <li>Due Diligence: Agents must be vetted for background, character, and credit history</li>
//         <li>Formal Agreement: Must include terms of engagement and code of conduct</li>
//         <li>Training & Certification: Agents must be trained and certified by IIBF</li>
...
const TypesOfMIS = lazy(() => import('../components/LearnDashboardComponents/TypesOfMIS'));
const LendingProducts = lazy(() => import('../components/LearnDashboardComponents/LendingProducts'));
const FieldCollection = lazy(() => import('../components/LearnDashboardComponents/FieldCollection'));
const DPDStages = lazy(() => import('../components/LearnDashboardComponents/DPDStages'));
const DialerTypes = lazy(() => import('../components/LearnDashboardComponents/DialerTypes'));
const CommonTerms = lazy(() => import('../components/LearnDashboardComponents/CommonTerms'));
const CollectionPhrases = lazy(() => import('../components/LearnDashboardComponents/CollectionPhrases'));
const DRAAbout = lazy(() => import('../components/LearnDashboardComponents/DRAAbout'));
const DRACertification = lazy(() => import('../components/LearnDashboardComponents/DRACertification'));
const DRAShort = lazy(() => import('../components/LearnDashboardComponents/DRAShort'));
const DRATraining = lazy(() => import('../components/LearnDashboardComponents/DRATraining'));
const DRAQuestions = lazy(() => import('../components/LearnDashboardComponents/DRAQuestions'));
const JudiciaryLegal = lazy(() => import('../components/LearnDashboardComponents/JudiciaryLegal'));
const LegalActions = lazy(() => import('../components/LearnDashboardComponents/LegalActions'));
const NCLTNCLAT = lazy(() => import('../components/LearnDashboardComponents/NCLTNCLAT'));
const RBIGuidelines = lazy(() => import('../components/LearnDashboardComponents/RBIGuidelines'));
const LegalNotices = lazy(() => import('../components/LearnDashboardComponents/LegalNotices'));

// Import icons individually (reduce bundle size)
...
const Dashboard = () => {
  const [activeContent, setActiveContent] = useState('types-mis');
  ...
  const tabs = [
    { 
      id: 0, 
      name: "Common Debt Info & Activities", 
      dropdownItems: [
        { id: "types-mis", name: "Types of MIS & Dashboards", icon: <FaChartBar /> },
        { id: "lending-products", name: "Lending Products", icon: <FaHandHoldingUsd /> },
        { id: "field-collection", name: "Field Collection & SOP Framework", icon: <FaUsers /> },
        { id: "dpd-stages", name: "DPD & stages with sample messaging action list_Suppcohort", icon: <FaExclamationTriangle /> },
        { id: "dialer-types", name: "Dialer types and uses", icon: <FaPhone /> },
        { id: "common-terms", name: "Common Terms Used", icon: <FaBook /> },
        { id: "collection-phrases", name: "CollectionRecovery sample phrases Templates", icon: <FaComments /> }
      ]
    },
    { 
      id: 1, 
      name: "DRA", 
      dropdownItems: [
        { id: "dra-about", name: "DRA About", icon: <FaInfoCircle /> },
        { id: "dra-certification", name: "DRA Certification insight", icon: <FaAward /> },
        { id: "dra-short", name: "DRA in short", icon: <FaGraduationCap /> },
        { id: "dra-training", name: "DRA_Training Modules_Deck", icon: <FaBookReader /> },
        { id: "dra-questions", name: "Sample Questions _DRA", icon: <FaQuestionCircle /> }
      ]
    },
    { 
      id: 2, 
      name: "Legal & Guidance CoC", 
      dropdownItems: [
        { id: "judiciary-legal", name: "Judiciary & Legal Forums & SOP", icon: <FaBalanceScale /> },
        { id: "legal-actions", name: "Legal Actions_Vehicle Loan", icon: <FaCar /> },
        { id: "nclt-nclat", name: "NCLT & NCLAT", icon: <FaUniversity /> },
        { id: "rbi-guidelines", name: "RBI Guidelines & CoC", icon: <FaShieldAlt /> },
        { id: "legal-notices", name: "Types of Legal Notices & Sample", icon: <FaFileAlt /> }
      ]
    }
  ];
  ...
  const getActiveContentTitle = () => {
    for (const tab of tabs) {
      for (const item of tab.dropdownItems) {
        if (item.id === activeContent) {
          return item.name;
        }
      }
    }
    ...
    <div className="dashboard-container">
      <div className="sidebar">
        <div className="logo">
          ...
          <p>Comprehensive debt recovery platform</p>
        </div>
        <ul className="tabs">
          {tabs.map(tab => (
            <li key={tab.id} className={openDropdown === tab.id ? 'active' : ''}>
              <div 
              ...
              >
                ...
                <div className="dropdown-toggle">
                  {openDropdown === tab.id ? <FaChevronDown /> : <FaChevronRight />}
                </div>
              </div>
              {openDropdown === tab.id && (
                <ul className="dropdown-menu">
                  {tab.dropdownItems.map((item) => (
                    <li 
                      ...
                      className={activeContent === item.id ? 'active-sub' : ''}
                    >
      ...
      <div className="main-content">
        <div className="content-header">
          <h1>{getActiveContentTitle()}</h1>
          <p>{getActiveTabName()}</p>
        </div>
        <div className="content-body">
...
const ContentRenderer = ({ activeContent }) => {
  const ComponentMap = {
    'types-mis': TypesOfMIS,
    'lending-products': LendingProducts,
    'field-collection': FieldCollection,
    'dpd-stages': DPDStages,
    'dialer-types': DialerTypes,
    'common-terms': CommonTerms,
    'collection-phrases': CollectionPhrases,
    'dra-about': DRAAbout,
    'dra-certification': DRACertification,
    'dra-short': DRAShort,
    'dra-training': DRATraining,
    'dra-questions': DRAQuestions,
    'judiciary-legal': JudiciaryLegal,
    'legal-actions': LegalActions,
    'nclt-nclat': NCLTNCLAT,
    'rbi-guidelines': RBIGuidelines,
    'legal-notices': LegalNotices,
  };

  const ComponentToRender = ComponentMap[activeContent] || TypesOfMIS;
