      ...
      <div className='policy-container'>
        <div className="policy-header">
          <h1 className="policy-title">
            Return Policy & Terms: Hassle-Free Shopping with suppcohort
          </h1>
        </div>

        <div className="policy-section">
         <p>
            The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to Suppcohort and the terms
            "Visitor” ”User” refer to the users.

            This page states the Terms and Conditions under which you (Visitor) may visit this website
            (“www.suppcohort.com”). Please read this page carefully. If you do not accept the Terms and Conditions
        ...
        <div className="policy-section">
          <h2 className="section-title">Acceptable Website Use</h2>
          ...
          <h3 className="subsection-title">(B) General Rules</h3>
          <p>
        ...
        <div className="policy-section">
          ...
          <p>
            The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of www.suppcohort.com or their breach of the terms.
          </p>
        </div>
        ...
        <div className="policy-section">
          <h2 className="section-title">Disclaimer of Consequential Damages</h2>
          <p>
