    ...
    <>
      ...
      <div className='policy-container'>
        ...
        <p>
            ...
            The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to suppcohort Pvt Ltd. and the
            ...
            This Privacy Policy is a legally binding document between you and suppcohort Pvt Ltd. (both terms defined
            ...
            and will govern the relationship between you and suppcohort Pvt Ltd. for your use of the website “Website”
            (www.suppcohort.com).
        ...
        <div className="policy-section">
          ...
          <h3 className="subsection-title">(A) Security Rules</h3>
         <p>
        ...
        <div className="policy-section">
          <h2 className="section-title">Information Sharing with Third Parties</h2>
         <p>
        ...
        <p>
            Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Udham Pal  (Dirctor).

            Mr. Udham Pal  (Dirctor)
            www.suppcohort.com
            Company Name & Address
           Address: Bldg No 5, 2nd Floor, Park End, Vikas Marg, Preet Vihar New Delhi - 110092
            Email: udham.pal@suppcohort.com,
            Ph: 9910098594, +91 9873120702
        </p>
        </div>
      </div>
    </>
